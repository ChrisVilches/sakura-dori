...
# These icons can be scraped manually by first making the emoji panel visible,
# then execute this JavaScript:
# const children = [...document.querySelectorAll('#emoji[aria-label=YouTube]')[0].children]
# const values = children.map(element => [element.getAttribute('src'), element.getAttribute('alt')])
